...
export default function Navbar() {
  return (
    <nav className="z-40 rounded-2xl shadow-lg mb-12 max-w-7xl mx-auto sticky top-8 bg-white  flex items-center justify-between px-6 lg:px-10 py-6">
      <Link to="home" smooth={true} offset={-100} duration={750} className="text-xs sm:text-sm font-extrabold uppercase bg-primary cursor-pointer text-white px-4 py-2 rounded-full shadow-lg">
        Sabry
      </Link>
      ...
      <a
        href="https://drive.google.com/file/d/1fPRWH9bKz_vwETeCyFAZdi4v9FUr-90U/view?usp=sharing"
        target="_blank"
